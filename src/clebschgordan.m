...
%
% http://mathworld.wolfram.com/Clebsch-GordanCoeffichintent.html
%
% mikael.mieskolainen@cern.ch, 2017

function [gg,a,b] = clebschgordan(j1,j2,m1,m2, j,m)
...
gg = (-1)^(m+j1-j2)*sqrt(2*j+1) * W3j(j1,j2,j,m1,m2,-m); % !! Note minus on m
